...
class BookNowLinkRewriter {
  element(element) {
    element.setAttribute('href', 'booknow.html');
  }
}
...
function getCorsOrigin(request) {
  ...
  if (origin === WORKER_ORIGIN || LIVE_ORIGINS.has(origin)) return origin;
  return origin ? null : 'https://tb-sweeps.com';
}
